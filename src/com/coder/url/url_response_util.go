...
func WriteDataCollectionStatsToFile() {
	...
	StatsLogger.Infof("==================================== Data collection stats ====================================")
	StatsLogger.Infof("hosts_200_counter : "+strconv.Itoa(hosts_200_counter))
	StatsLogger.Infof("hosts_301_counter : "+strconv.Itoa(hosts_301_counter))
	StatsLogger.Infof("hosts_3xx_counter : "+strconv.Itoa(hosts_3xx_counter))
	StatsLogger.Infof("hosts_4xx_counter : "+strconv.Itoa(hosts_4xx_counter))
	StatsLogger.Infof("hosts_5xx_counter : "+strconv.Itoa(hosts_5xx_counter))
	StatsLogger.Infof("successUrlCounter : "+strconv.Itoa(successUrlCounter))
	StatsLogger.Infof("errorUrlCounter : "+strconv.Itoa(errorUrlCounter))
	StatsLogger.Infof("totalUrlCounter : "+strconv.Itoa(totalUrlCounter))
...
func ParseFastHttpResponse(err error, resp *fasthttp.Response, urlStats *UrlStats, websiteJob *WebsiteJob){
    ...
    if err == nil {
    	...
    	SuccessUrlLogger.Infof("Id : ",index,", Url : ",url,", Status code : ",resp.StatusCode(),", urlStats : ",urlStats)
    } else {
	    errorUrlCounter += 1
    	...
    	error_hosts_vs_error.WriteString("\n")
    	ErrorUrlLogger.Infof("Id : ",index,", Url : ",url,", err : ",err)
