...
buildMonAgent() {
	...
	echo "Deleting old binaries in the folder : $WORK_GO_SERVER_MONITORING_AGENT_BIN_SERVER_MONITORING_AGENT"
	rm -rf $WORK_GO_SERVER_MONITORING_AGENT_BIN_SERVER_MONITORING_AGENT/*
	#Building server monitoring agent
	echo "Building $WORK_GO_SERVER_MONITORING_AGENT_CMD_MONAGENT/monagent.go"
	go build $WORK_GO_SERVER_MONITORING_AGENT_CMD_MONAGENT/monagent.go -o $WORK_GO_SERVER_MONITORING_AGENT_BIN_SERVER_MONITORING_AGENT/$GO_SERVER_MONITORING_AGENT_BINARY_FILE_NAME 
	...
	cp -rf $WORK_GO_SERVER_MONITORING_AGENT_CMD_MONAGENT/conf $WORK_GO_SERVER_MONITORING_AGENT_BIN_SERVER_MONITORING_AGENT_CONF

	#Copying script files
	echo "Copying script files to $WORK_GO_SERVER_MONITORING_AGENT_BIN_SERVER_MONITORING_AGENT_SCRIPTS"
	cp -rf $WORK_GO_SERVER_MONITORING_AGENT_CMD_MONAGENT/scripts $WORK_GO_SERVER_MONITORING_AGENT_BIN_SERVER_MONITORING_AGENT_SCRIPTS
}
